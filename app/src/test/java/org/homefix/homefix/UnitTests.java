...
public class UnitTests {
    ...
    @Test
    public void testSetDidAuth(){
        boolean t = true;
        assertEquals(setdidAuth(true),true);

    }

    @Test
    public void testGetDidAuth(){
        setdidAuth(true);
        boolean b = getdidAuth();
    ...
    public void testValidatePassword(){
        ...
        assertEquals("validatePassword Failed", validatePassword(s,s2), false);
